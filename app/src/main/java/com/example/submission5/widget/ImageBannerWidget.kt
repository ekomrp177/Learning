...
class ImageBannerWidget : AppWidgetProvider() {
    ...
    companion object {
        ...
        const val TOAST_ACTION = "com.example.submission5.TOAST_ACTION"
        const val EXTRA_ITEM = "com.example.submission5.EXTRA_ITEM"
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        if (intent.action != null) {
            ...
            if (intent.action == UPDATE_WIDGET){
                val appWidgetIds = AppWidgetManager.getInstance(context).getAppWidgetIds(ComponentName(context, ImageBannerWidget::class.java))
